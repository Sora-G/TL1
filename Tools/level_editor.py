...
#オペレータ  ICO球を生成する
class MYADDON_OY_create_ico_sphere(bpy.types.Operator):
...
class TOPBAR_MT_my_menu(bpy.types.Menu):
    ...
    def draw(self,context):
        ...
        self.layout.operator(MYADDON_OY_create_ico_sphere.bl_idname,text=MYADDON_OY_create_ico_sphere.bl_label)
